...
python /weka/oe-adapt-default/tengx/main/open-instruct/mason.py \
  ...
  --output-file /weka/oe-adapt-default/tengx/main/open-instruct/scripts/data/MathSub_test_vllm_0_1_qwen_1.jsonl \
  --number_samples 8
...
python /weka/oe-adapt-default/tengx/main/open-instruct/mason.py \
  ...
  --size 8 \
  --tensor_parallel_size 1 \
  --output-file /weka/oe-adapt-default/tengx/main/open-instruct/scripts/data/MathSub_test_vllm_0_8_qwen_1.jsonl \
  --number_samples 8
...
python /weka/oe-adapt-default/tengx/main/open-instruct/mason.py \
  ...
  --size 16 \
  --tensor_parallel_size 1 \
  --output-file /weka/oe-adapt-default/tengx/main/open-instruct/scripts/data/MathSub_test_vllm_0_16_qwen_1.jsonl \
  --number_samples 8
...
python /weka/oe-adapt-default/tengx/main/open-instruct/mason.py \
  ...
  --size 64 \
  --tensor_parallel_size 1 \
  --output-file /weka/oe-adapt-default/tengx/main/open-instruct/scripts/data/MathSub_test_vllm_0_64_qwen_1.jsonl \
  --number_samples 8
